...
int main()
{
    ...
    Texture t;
    t.loadFromFile("C:\\Users\\vladk\\Downloads\\tiles.png");
    mi.nameGame.setTexture(t);
    mi.startGame.setTexture(t);
    mi.results.setTexture(t);
    mi.exit.setTexture(t);

    mi.recordCountSprite.setTexture(t);
    mi.lastCountSprite.setTexture(t);
    mi.backSprite.setTexture(t);

    mi.nameGame.setPosition(0, 0);
    mi.startGame.setPosition(0, w * 5);
    mi.results.setPosition(0, w * 7);
    mi.exit.setPosition(0, w * 9);

    mi.recordCountSprite.setPosition(0, w * 5);
    mi.lastCountSprite.setPosition(0, w * 7);
    mi.backSprite.setPosition(0, 0);
    ...
    while (window.isOpen()) {
        ...
        if (state == 0) {
            ...
            window.draw(mi.nameGame);
            window.draw(mi.startGame);
            window.draw(mi.results);
            window.draw(mi.exit);
            ...
            window.draw(mi.recordCountSprite);
            window.draw(mi.lastCountSprite);
